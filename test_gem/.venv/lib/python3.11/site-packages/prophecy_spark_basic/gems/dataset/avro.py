...
class avro(DatasetSpec):
    ...
    docUrl: str = "https://docs.prophecy.io/engineers/avro/"
        ...
        locationPath = StackLayout(height=("100%")) \
                        .addElement(
                            AlertBox(
                                ...
                                _children=[
                                    Markdown(
                                        "This Gem has the following requirement(s): Configure the [spark-avro](https://mvnrepository.com/artifact/org.apache.spark/spark-avro) Maven dependency on the Spark cluster."
                                    )
                                ]
                            )
