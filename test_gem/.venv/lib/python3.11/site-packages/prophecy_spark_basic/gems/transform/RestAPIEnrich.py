...
class RestAPIEnrich(ComponentSpec):
    ...
    category: str = "Custom"
    gemDescription: str = ""
    docUrl: str = "https://docs.prophecy.io/engineers/rest-api-enrich/"
    ...
    def dialog(self) -> Dialog:
        def create_dialog(heading, from_bind_prop, df_value, static_value, prop):
            return (
                ...
                .addElement(
                    SelectBox("")
                    .addOption("DataFrame column or SQL Expression", "existingColumn")
                ...
                .addElement(
                    (
                        ...
                        .then(
                            ExpressionBox("", language="sql", ignoreTitle=True)
    ...
    class RestAPIEnrichCode(ComponentCode):
        ...
        def apply(self, spark: SparkSession, in0: DataFrame) -> DataFrame:
            ...
            if self.props.params is not None:
                params = (
                    expr(self.props.params).alias("params")
            ...
            if self.props.data is not None:
                data = (
                    expr(self.props.data).alias("data")
            ...
            if self.props.json is not None:
                json = (
                    expr(self.props.json).alias("json")
            ...
            if self.props.headers is not None:
                headers = (
                    expr(self.props.headers).alias("headers")
            ...
            if self.props.cookies is not None:
                cookies = (
                    expr(self.props.cookies).alias("cookies")
            ...
            if self.props.auth is not None:
                auth = (
                    expr(self.props.auth).alias("auth")
            ...
            if self.props.timeout is not None:
                timeout = (
                    expr(self.props.timeout).alias("timeout")
            ...
            if self.props.allow_redirects is not None:
                allow_redirects = (
                    expr(self.props.allow_redirects).alias("allow_redirects")
            ...
            if self.props.proxies is not None:
                proxies = (
                    expr(self.props.proxies).alias("proxies")
            ...
            if self.props.verify is not None:
                verify = (
                    expr(self.props.verify).alias("verify")
            ...
            if self.props.stream is not None:
                stream = (
                    expr(self.props.stream).alias("stream")
            ...
            if self.props.cert is not None:
                cert = (
                    expr(self.props.cert).alias("cert")
