...
class SetOperation(ComponentSpec):
    ...
    docUrl: str = "https://docs.prophecy.io/engineers/set-operation/"
    ...
    def dialog(self) -> Dialog:
        return Dialog("SetOperation").addElement(
            ...
            .addColumn(
                ...
                .addElement(
                    Condition().ifEqual(PropExpr("component.properties.operationType"), StringExpr("unionByName"))
                        .then(Checkbox("Allow missing columns").bindProperty(
                        "allowMissingColumns"))
                ),
                "2fr"
            )
    ...
    def validate(self, context: WorkflowContext, component: Component[SetOperationProperties]) -> List[Diagnostic]:
        ...
        #         if anomalousKey.lower() != baselineKey.lower():
        #             diffs.append(
        ...
        #                 return []
        #     else:
        #         if component.properties.allowMissingColumns and component.properties.operationType == "unionByName":
        #             return []
        #         else:
