...
class Reformat(ComponentSpec):
    ...
    docUrl: str = "https://docs.prophecy.io/engineers/reformat/"
                ...
                AlertBox(
                    ...
                    _children=[
                        Markdown(
                            ...
                            "✅ Please switch to **Expressions** tab to save the expressions"
                        )
                    ]
                )
            )
    ...
    def validate(self, context: WorkflowContext, component: Component[ReformatProperties]) -> List[Diagnostic]:
        ...
        expTableDiags = validateExpTable(component.properties.expressions, "expressions", component, None)
